...
$this->table->add_row(form_label('Search for', 'search_for'), form_dropdown('search_for', array('patient'=>'Members','er_card'=>'ER Cards','asp'=>'Affiliated Service Providers','dnd'=>'Dentists and Doctors'), '','id="search_for"'));
$this->table->add_row(form_label('Keyword', 'keyword'), form_input(array('name'=>'keyword', 'id'=>'keyword', 'size'=>'50','class'=>'form-control')),form_button(array('name'=>'filter_on','id'=>'filter_on','class'=>'btn btn-info','content'=>'Filtered Search')));
$template = array(
...
<?php
	...
	$filtered_form = array(
				...
				array(form_label('Company:'),form_input(array('name'=>'company','id'=>'company','size'=>'20','placeholder'=>'Company Name','class'=>'form-control')),
					form_label('Insurance:'),form_input(array('name'=>'insurance','id'=>'insurance','size'=>'20','placeholder'=>'Insurance Name','class'=>'form-control')),''),
